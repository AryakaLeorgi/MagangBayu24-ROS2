...
class AlternatingPublishers(Node):
    def __init__(self):
        ...
        self.publisher1 = self.create_publisher(Bool, 'publisher1', 10)
        self.timer1 = self.create_timer(2, self.publish_bool1)
        self.bool_value1 = True
        self.timer_count1 = 0

        self.publisher2 = self.create_publisher(Bool, 'publisher2', 10)
    ...
    def publish_bool1(self):
        ...
        self.get_logger().info(f'Published to publisher1: {self.bool_value1}')
    ...
    def publish_bool2(self):
        ...
        self.get_logger().info(f'Published to publisher2: {self.bool_value2}')
